...
public class LoggingWriter implements MessageBodyWriter {
	...
	public boolean isWriteable(Class type, Type genericType, Annotation[] annotations, MediaType mediaType) {
		if (LogResource.class.isAssignableFrom(type)) return true;
		else if (LogDataEntryResource.class.isAssignableFrom(type)) return true;
			 ...
			 if (LogDataEntryResource.class.isAssignableFrom(typeClass)) return true;
		}
		return false;
	}
