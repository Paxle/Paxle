 ...
 * <p>
 * Please note: I (Franz Brausse) have put this code in the org.paxle.crypt.md5
...
public class MD5 {
	...
	public static final String NATIVE_LIB_FILE_SYSTEM_PROP = "com.twmacinta.util.MD5.NATIVE_LIB_FILE";
	public static final String NATIVE_LIB_NOUSE_SYSTEM_PROP = "com.twmacinta.util.MD5.NO_NATIVE_LIB";
	...
	private static synchronized final boolean _loadNativeLibrary() {
		try {
			...
			String prop = System
					.getProperty(NATIVE_LIB_NOUSE_SYSTEM_PROP);
			if (prop != null) {
				prop = prop.trim();
			...
			File f;
			prop = System.getProperty(NATIVE_LIB_FILE_SYSTEM_PROP);
			if (prop != null) {
				f = new File(prop);
				if (f.canRead()) {
