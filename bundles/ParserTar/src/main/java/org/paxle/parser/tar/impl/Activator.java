...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
		bc = context;
		final ISubParser sp = new TarParser();
		Hashtable<String,Object> props = new Hashtable<String,Object>();
		List<String> mimeTypes = sp.getMimeTypes();
		props.put(Constants.SERVICE_PID, ITarParser.class.getName());
		props.put(ISubParser.PROP_MIMETYPES, mimeTypes.toArray(new String[mimeTypes.size()]));
		context.registerService(new String[]{ISubParser.class.getName(), ITarParser.class.getName()}, sp, props);
	}
