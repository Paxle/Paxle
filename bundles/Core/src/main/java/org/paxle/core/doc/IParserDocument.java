...
public interface IParserDocument extends Closeable, Appendable, Flushable {
	 ...
	 * 
	 * @deprecated use {@link #addReference(URI, String, String)} instead
	 */
	 ...
	 * 	      It is recommended to use the {@link Constants#SERVICE_PID} for this, 
	 * 	      e.g. <code>service-pid:org.paxle.parser.pdf.impl.PdfParser</code>
	 * @see LinkInfo#ORIGIN
	 */
