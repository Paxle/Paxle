...
public interface ICommand extends Closeable {
	...
	/**
	 * Return the result of this command as defined in ICommand.Result.
	 * @return The last set Result value or Result.Passed
	 */
	@Nonnull
	...
	/**
	 * @return the systemwide unique ID of this command. 
	 *         This parameter is mainly used by the OR-mapping.
	 */
    public int getOID(); 

    /**
     * @param OID the systemwide unique ID of this command.
